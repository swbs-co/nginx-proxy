...
### Predictable vs SHA1 upstream names
...
Please note that using regular expressions in `VIRTUAL_HOST` will always result in a corresponding `upstream` block with an SHA1 name instead of a predictable name.
